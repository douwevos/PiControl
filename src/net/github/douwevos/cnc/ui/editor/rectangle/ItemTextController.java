...
import net.github.douwevos.cnc.model.TextLayoutToModelGraphics;
...
public class ItemTextController implements ItemController {
	...
	public void paint(ModelGraphics modelGraphics, EditableLayer layer, Editable item) {
		...
		EditableText editableText = (EditableText) item;
		TextLayout textLayout = editableText.getTextLayout();
		long textSize = editableText.getTextSize();
		Point2D location = editableText.getLocation();
		TextLayoutToModelGraphics textLayoutToModelGraphics = new TextLayoutToModelGraphics();
		modelGraphics.colorDefault();
		textLayoutToModelGraphics.draw(modelGraphics, textLayout, textSize, location);
