...
public class LayerLine {
	...
	public LayerLine duplicate() {
		LayerLine copy = new LayerLine();
...
//		copy.rawDots = rawDots == null ? null :  new ArrayList<>(rawDots);
	...
	public void exclude(LayerLine layerLine) {
		for(StartStop ss : layerLine.startStops) {
			cut(ss.start, ss.stop);
		}
	}
	
	public void edge(LayerLine linePre, LayerLine linePost) {
...
//					System.out.println("  adding post");
	...
	private void edgeStartStop(LayerLine sourceLine, List<StartStop> cropped, StartStop ss) {
		cropped.clear();
...
//			}
	...
	public static void main(String[] args) {
		LayerLine linePre = new LayerLine();
		LayerLine linePost = new LayerLine();
...
//		System.out.println(layerLine);
	...
	public void merge(LayerLine mergeLine) {
